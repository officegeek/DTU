...
Den der viser de forskellige opgaver er en kombination af 2 **IF** og 2 **AND** betingelser, desuden bruges der to navngivne områder: **Opgave_Start** og **Opgave_Slut**.

De navngivne områder er defineret som:

- **Opgave_Start** = $C10 - Altså **C** kolonnen fra række 10 og *frem*
- **Opgave_Slut** =  $E10 -  Altså **E** kolonnen fra række 10 og *frem*

Måden du gør det på er markere cellen **C10** og for **Opgave_Start** og cellen **E10** for **Opgave_Slut**.
...
- Udfyld felterne:
    ...
    - *Scope*: **Gant_Start**
    - *Referes to*: **=Gant_Start!$C10** - Det er vigtigt at du kun har **C** som absolut reference ($)

![](./image/navngiv.jpg)

### Betinget formatering
Det er betinget formatering der bruges til at markere opgaverne og DagsDato, brug denne formel til opgaverne:
